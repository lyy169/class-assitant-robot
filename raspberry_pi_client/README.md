...
- 多模型接入：可选DeepSeek/OpenAi/豆包大模型等，支持聊天上下文
...
为了使用语音识别以及文字转语音，选择注册微软Azure/豆包，获取APIkey

### 硅基流动云服务/GPT服务/星火API/豆包

为了生成对话文本，需要注册硅基流动/OpenAI/讯飞星火账号/豆包（四选一），并获取APIkey
