...
RESOURCE_FILE = os.path.join("snowboy", "resources", "common.res")
DETECT_DING = os.path.join("snowboy", "resources", "ding.wav")
DETECT_DONG = os.path.join("snowboy", "resources", "dong.wav")
