...
def _db_connect():
    return pymysql.connect(
        host=os.environ.get("SCHEDULE_DB_HOST", "127.0.0.1"),
        user=os.environ.get("SCHEDULE_DB_USER", "root"),
        password=os.environ.get("SCHEDULE_DB_PASSWORD", ""),
        database=os.environ.get("SCHEDULE_DB_NAME", "schedule"),
    )
